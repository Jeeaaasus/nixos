{
  inputs = {
    ...
    pkgs-20251218.url = "github:NixOS/nixpkgs?rev=108c36953a75771675e0056bb94f2467784353cf";
  ...
  outputs = { self, ... }@inputs:
    let
      ...
      pkgs_20251218 = mkPkgs inputs.pkgs-20251218;
...

    {
      nixosConfigurations.${vars.hostname} = inputs.nixpkgs.lib.nixosSystem {
        inherit system pkgs;
        specialArgs = {
          inherit inputs vars pkgs_stable pkgs_20251218 pkgs_20260326 pkgs_20260515;
        };
