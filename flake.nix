{
  inputs = {
    ...
    pkgs-20260212.url = "github:NixOS/nixpkgs?rev=c53e5d1c2bfc2b905062022bee7380609f0f5029";
  ...
  outputs = { self, ... }@inputs:
    let
      ...
      pkgs_20260212 = mkPkgs inputs.pkgs-20260212;
...

    {
      nixosConfigurations.${vars.hostname} = inputs.nixpkgs.lib.nixosSystem {
        inherit system pkgs;
        specialArgs = {
          inherit inputs vars pkgs_stable pkgs_20260212 pkgs_20260326 pkgs_20260515;
        };
